  ...
  en: {
    ...
    solutions: {
      ...
      freePlan: {
        ...
        features: [
          { key: "cpuShare", label: "75% CPU • 0.75 vCores" },
          { key: "memory", label: "1 GB RAM" },
          { key: "storage", label: "8GB SSD storage" },
  ...
  de: {
    ...
    servicesPageV2: {
      ...
      coding: {
        ...
        features: [
          "75 % geteilte vCPU, 1024 MiB RAM und 8 GiB SSD-Speicher pro Workspace",
    ...
    solutions: {
      ...
      freePlan: {
        ...
        features: [
          { key: "cpuShare", label: "75 % CPU • 0,75 vCores" },
          { key: "memory", label: "1 GB RAM" },
          { key: "storage", label: "8 GB SSD-Speicher" },
  ...
  fr: {
    ...
    servicesPageV2: {
      ...
      coding: {
        ...
        features: [
          "75 % de vCPU partagée, 1 GB de RAM et 8GB de SSD par workspace",
    ...
    solutions: {
      ...
      freePlan: {
        ...
        features: [
          { key: "cpuShare", label: "75 % de CPU • 0,75 vCores" },
          { key: "memory", label: "1 GB de RAM" },
          { key: "storage", label: "8 GB de stockage SSD" },
