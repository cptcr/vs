...
export const metadata = buildMetadata({
  ...
  description:
    'Policies describing acceptable and prohibited use of VaultScope services.',
  path: '/acceptable-use',
});
        ...
        <div className="space-y-8 text-foreground">
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              <p>
                This Acceptable Use Policy (AUP) outlines prohibited uses of
                VaultScope's hosting services. Violation of this policy may
              ...
              <ul className="pl-6 mt-4 space-y-2 list-disc text-muted-foreground">
                <li>
                  <strong className="text-foreground">Adult Content:</strong>{' '}
                  Pornography, sexually explicit material, or adult services
                </li>
                <li>
                  <strong className="text-foreground">Hate Speech:</strong>{' '}
                  Content promoting violence, discrimination, or hatred based on
                  race, religion, gender, sexual orientation, or other protected
                  characteristics
                </li>
                <li>
                  <strong className="text-foreground">Pirated Content:</strong>{' '}
                  Copyrighted material without authorization, warez, cracks, or
                ...
                <li>
                  ...
                  Malware, viruses, trojans, ransomware, or any harmful code
                </li>
                <li>
                  <strong className="text-foreground">Phishing:</strong>{' '}
                  Fraudulent websites or content designed to steal credentials
                ...
                <li>
                  ...
                  Any content involving minors in inappropriate contexts (zero
                  tolerance)
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              ...
              <ul className="pl-6 space-y-2 list-disc">
                <li>
                  Online gambling or casino services (unless legally licensed)
                </li>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              ...
              <ul className="pl-6 space-y-2 list-disc">
                ...
                <li>
                  Not automate panel actions in ways that cause excessive load
                </li>
                <li>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              ...
              <ul className="pl-6 space-y-2 list-disc">
                ...
                <li>
                  Comply with GDPR, CCPA, and other privacy regulations if
                  collecting user data
                </li>
                <li>
                  Maintain appropriate terms of service and privacy policies for
                  your applications
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              <p>
                Your service includes specific resource allocations (40% CPU,
                512 MB RAM, 5120 MB storage, 5 ports). You must:
              </p>
              <ul className="pl-6 space-y-2 list-disc">
                ...
                <li>
                  Not run services designed to consume maximum resources
                  continuously
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              ...
              <ul className="pl-6 space-y-2 list-disc">
                ...
                <li>
                  Configuring firewalls and security settings appropriately
                </li>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              <p>
                If you become aware of any violations of this AUP, please report
                them immediately through:
              </p>
              <ul className="pl-6 space-y-2 list-disc">
                <li>
                  Discord:{' '}
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              ...
              <ul className="pl-6 space-y-2 list-disc">
                ...
                <li>
                  ...
                  Temporary service suspension while investigation occurs
                </li>
                <li>
                ...
                <li>
                  ...
                  Violations result in forfeiture of any paid services
                </li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              <p>
                We may update this AUP at any time. Continued use of our
                services after changes constitutes acceptance. It is your
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-muted-foreground">
              <p>
                If you have questions about what is or isn't allowed under this
                policy, please contact us before proceeding. We're happy to
