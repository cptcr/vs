...
const cookieCategories = [
  {
    ...
    description: "Required to provide authentication, security, and core functionality. These cannot be disabled.",
    examples: [
      { name: "vaultscope_lang", purpose: "Stores your language selection so the UI renders in your preferred locale.", expires: "1 year" },
      { name: "session_token", purpose: "Maintains authenticated sessions in the control panel.", expires: "Session" },
    ],
  },
  {
    title: "Functional",
    description: "Enhance the experience but are not critical to deliver the service.",
    examples: [
      { name: "docs_sidebar_state", purpose: "Remembers the expanded/collapsed state of the documentation sidebar.", expires: "30 days" },
    ],
  },
  {
    title: "Analytics & performance",
    description: "Help us understand how the site is used so we can improve reliability and features.",
    examples: [
      {
        name: "_ga, _gid (Google Analytics)",
        purpose: "Collect aggregated usage information such as visited pages, browser type, and referral sources.",
        expires: "13 months",
      },
    ],
  },
  {
    ...
    description: "Set by Stripe when you access the billing portal to detect and prevent fraudulent activity.",
    examples: [
      { name: "__stripe_mid / __stripe_sid", purpose: "Protect checkout flows and enforce Stripe security policies.", expires: "1 year / 30 minutes" },
    ],
  },
]
      ...
      <main className="container mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-foreground">
          <section className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              Cookies are small text files stored on your device. Some are essential to run our services; others help us analyze
              traffic, remember preferences, or enable secure payments. By continuing to browse our sites, you agree to the use
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
              ...
              <p>
                Essential cookies (authentication, load balancing, or security) cannot be disabled because the site will not function without them.
              </p>
            </div>
          </section>
                    ...
                    <table className="min-w-full divide-y divide-white/10 text-left text-sm text-muted-foreground">
                      ...
                      <tbody className="divide-y divide-white/10">
                        {category.examples.map((example) => (
                          <tr key={example.name}>
                            <td className="px-4 py-3 text-white">{example.name}</td>
          ...
          <section className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <ul className="list-disc space-y-2 pl-6 text-sm">
              ...
              <li>
                <strong className="text-foreground">Google Analytics:</strong> used to understand aggregate traffic patterns. IP addresses are anonymized in the EU.
              </li>
              <li>
                <strong className="text-foreground">Trustpilot:</strong> may set cookies when you follow a review invitation after an order, activation, or cancellation.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              Safari, Edge, or Brave for instructions. Blocking essential cookies may prevent you from logging in or completing purchases.
            </p>
          </section>
