...
const stats = [
  {
    ...
    description:
      'Strategic footprint in a carrier-neutral facility with worldwide network reach.',
  },
  {
    value: '99.0%',
    label: 'Platform uptime',
    description:
      'Measured across core services with transparent incident postmortems.',
  },
  {
    value: '15 min',
    label: 'Median deployment window',
    description:
      'Average time from confirmed order to production-ready workload.',
  },
];
...
export const metadata = buildMetadata({
  title: 'About',
  description:
    "Learn about VaultScope's mission, team values, and commitment to reliable infrastructure.",
  path: '/about',
});
      ...
      <main className="relative z-10">
        <section className="container px-4 py-24 mx-auto sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mt-6">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
              Purpose-built reliability, security, and easy deployment for your
              infrastructure ambitions
            </h1>
            <p className="mt-6 text-lg text-muted-foreground">
              VaultScope began as CPTCR Hosting, a small collective determined
              to remove the downtime anxiety that slows modern teams. After a
              strategic pause in 2024 to rebuild our foundations, we relaunched
              in 2025 under the VaultScope name—laser-focused on reliability,
              layered security, and effortless deployment experiences.
            </p>
          </div>
            ...
            {stats.map((stat) => (
              ...
              >
                <CardHeader className="space-y-2">
                  ...
                  <p className="text-sm tracking-wide uppercase text-primary/80">
                    {stat.label}
                  </p>
                </CardHeader>
        ...
        <section className="container px-4 pb-20 mx-auto sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-semibold sm:text-4xl">
              How we deliver trust at scale
            </h2>
            <p className="mt-4 text-base text-muted-foreground">
              The VaultScope platform blends dedicated hardware, multi-cloud
              connectivity, and orchestrated observability to meet demanding
              workloads without sacrificing ownership or flexibility.
            </p>
          </div>
          <div className="grid gap-6 mt-10 md:grid-cols-2 lg:grid-cols-3">
            {pillars.map((pillar) => {
              ...
              return (
                <Card
                  key={pillar.title}
                  className="border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent"
                >
        ...
        <section className="container px-4 pb-20 mx-auto sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_360px]">
            <div>
              <h2 className="text-3xl font-semibold sm:text-4xl">
                Milestones that shaped VaultScope
              </h2>
              <p className="mt-4 text-base text-muted-foreground">
                We grow deliberately—prioritising reliability and customer
                impact over vanity metrics—so the platform you depend on keeps
                getting smarter.
              </p>
            ...
            <Card className="border-white/10 bg-white/5">
              <CardHeader>
                ...
                <CardDescription className="text-sm text-white/70">
                  Guided by feedback from platform, gaming, and SaaS teams
                  pushing global scale.
                </CardDescription>
              </CardHeader>
        ...
        <section className="container px-4 pb-20 mx-auto sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base text-muted-foreground">
              Our leadership team blends infrastructure engineering, customer
              reliability, and operations expertise so every launch is supported
          ...
          <Card className="relative overflow-hidden border-primary/30 bg-gradient-to-r from-primary/20 via-primary/10 to-transparent">
            ...
            <CardHeader className="relative">
              ...
              <CardDescription className="text-base text-white/80">
                Whether you&apos;re migrating legacy workloads, launching a new
                platform, or scaling a fast-moving game title, we&apos;d love to
                build alongside you.
              </CardDescription>
            </CardHeader>
            <CardContent className="relative flex flex-col gap-4 pt-0 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-sm text-white/80">
                Talk with our customer reliability team to map your
                architecture, migrate safely, and plan for what&apos;s next.
              </p>
              <Button
                asChild
                size="lg"
              ...
              >
                <a
                  href="https://discord.gg/8KAj4N5fgN"
                  target="_blank"
