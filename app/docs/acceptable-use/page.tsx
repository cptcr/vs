...
export const metadata = buildMetadata({
  title: "Acceptable Use — VaultScope Docs",
  description:
    ...
    <div className="max-w-3xl space-y-10">
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          If you&apos;re unsure whether something is allowed, email <a href="mailto:compliance@vaultscope.dev" className="font-medium text-primary underline underline-offset-4">compliance@vaultscope.dev</a> before you deploy.
        </p>
      </section>
      ...
      <section className="space-y-6" id="abuse">
        ...
        <p className="text-muted-foreground">
          Email abuse reports to <a href="mailto:abuse@vaultscope.dev" className="font-medium text-primary underline underline-offset-4">abuse@vaultscope.dev</a> or use the reporting form in the control panel.
        </p>
      </section>
      ...
      <section className="space-y-6 border-t border-border pt-8">
        ...
        <p className="text-muted-foreground">
          Reach <a href="mailto:policy@vaultscope.dev" className="font-medium text-primary underline underline-offset-4">policy@vaultscope.dev</a> for clarification. For contract-specific obligations, reference the terms in your SLA or enterprise addendum.
        </p>
      </section>
    </div>
  )
