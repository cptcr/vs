    ...
    <div className="max-w-3xl space-y-10">
      <header className="space-y-4">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
          Deploy Minecraft plugins from the panel
        </h1>
        <p className="text-lg text-muted-foreground">
          The Plugin Installer delivers curated plugins from providers like
          Modrinth. Filter by loader, version or provider and install straight
          to your VaultScope server.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Inside your server view, open the <em>More</em> menu and pick{' '}
          <em>Plugins Installer</em>. You&apos;ll land on the searchable plugin
          catalog.
        </p>
        <DocsScreenshot
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Search by name or browse trending options, then filter by Minecraft
          version, server loader or source. Each result surfaces descriptions,
          release cadence and outbound links.
        </p>
        <DocsScreenshot
      ...
      <section className="space-y-6">
        ...
        <ul className="pl-6 space-y-2 list-disc text-muted-foreground">
          <li>
            Select a plugin to review versions and changelog notes prior to
            installation.
          </li>
          <li>
            Click <strong>Install</strong> and VaultScope downloads the chosen
            release directly to your server.
          </li>
          <li>
            Restart the server so the plugin initializes alongside the rest of
            your mods.
          </li>
        </ul>
        <p className="text-sm text-muted-foreground">
          Need to roll back? Use the same view to install an earlier version or
          remove the plugin from the file manager.
        </p>
      </section>
    </div>
  );
