  ...
  return (
    <div className="max-w-3xl space-y-10">
      <header className="space-y-4">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Install Minecraft mods with confidence</h1>
        <p className="text-lg text-muted-foreground">
          VaultScope’s Mod Installer connects directly to popular providers like Modrinth so you can discover, filter and
          deploy mods without leaving the panel.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          From the server sidebar, click <em>More</em> and choose <em>Mods Installer</em>. The panel opens the curated
          catalog for your instance.
        </p>
        <DocsScreenshot
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Use the search bar or apply filters for game version, server loader (PaperMC, Forge and more) and provider. The
          list updates instantly so you can preview compatible releases.
        </p>
        <DocsScreenshot
          image={modsPage}
      ...
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">
          After the installer finishes, restart the server so the new mod loads with the rest of your plugins.
        </p>
      </section>
    </div>
  )
