    ...
    <div className="max-w-3xl space-y-10">
      <header className="space-y-4">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
          Manage players from the VaultScope console
        </h1>
        <p className="text-lg text-muted-foreground">
          The Players view surfaces every account connected to your Minecraft
          server—active, offline, banned and whitelisted—so you can take action
          in seconds.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Click <em>More</em> in the server sidebar and choose <em>Players</em>{' '}
          to access the live roster.
        </p>
        <DocsScreenshot
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          The roster groups players by status: active, offline, whitelisted,
          opped and banned. Scan summaries at a glance or drill into details for
          any player row.
        </p>
        <DocsScreenshot
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold">
          3. Take action on individual players
        </h2>
        <ul className="pl-6 space-y-2 list-disc text-muted-foreground">
          <li>
            Click a player to open the action drawer and confirm you&apos;re
            targeting the correct account.
          </li>
          <li>
            Run moderation steps like <em>Ban</em>, <em>Kick</em>,{' '}
            <em>Clear Inventory</em>, <em>Kill</em> or <em>Wipe</em>.
          </li>
          <li>
            Adjust access instantly with <em>Unwhitelist</em> or <em>Ban IP</em>
            , and review stats before you close.
          </li>
        </ul>
        <DocsScreenshot
