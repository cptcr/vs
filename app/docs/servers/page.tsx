    ...
    <div className="max-w-3xl space-y-10">
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          ...
          <Link href="/docs/quickstart" className="font-medium underline text-primary underline-offset-4">
            quickstart guide
          </Link>
          .
        </p>
      ...
      <section className="pt-8 space-y-6 border-t border-border">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <a href="mailto:support@vaultscope.dev" className="font-medium underline text-primary underline-offset-4">
