...
const faqs = [
  {
    ...
    items: [
      ...
      {
        question:
          'Do I need separate logins for billing and the control panel?',
        answer:
    ...
    <div className="max-w-3xl space-y-10">
      <header className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          Quick answers to the topics we see most often in tickets, live chat
          and Discord. Each answer links to a deeper guide when you want the
          full playbook.
        </p>
      </header>
      ...
      <section className="pt-8 space-y-4 border-t border-border">
        ...
        <p className="text-muted-foreground">
          ...
          , open a control panel ticket or join the{' '}
          <a
