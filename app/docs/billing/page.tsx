  ...
  return (
    <div className="max-w-3xl space-y-10">
      ...
      <section className="space-y-6">
        ...
        />
        <div className="rounded-lg border border-amber-500/40 bg-amber-500/10 px-4 py-3 text-sm leading-relaxed text-amber-200">
      ...
      <section className="space-y-6 border-t border-border pt-8">
        ...
        <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
          <li>Email <a href="mailto:billing@vaultscope.dev" className="font-medium text-primary underline underline-offset-4">billing@vaultscope.dev</a> for invoice updates.</li>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          <Link href="/docs/faq" className="font-medium text-primary underline underline-offset-4">
            FAQ
          </Link>{" "}
