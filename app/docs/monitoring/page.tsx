  ...
  return (
    <div className="max-w-3xl space-y-10">
      <header className="space-y-4">
        <p className="text-sm uppercase tracking-[0.2em] text-primary">Stay ahead of incidents</p>
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Monitoring and alerting strategy</h1>
        <p className="text-lg text-muted-foreground">
          Visibility is baked into the VaultScope control panel. Combine the built-in graphs with external exporters so
          you know about performance regressions before your players do.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
          ...
          <li>Use the <em>Activity</em> tab to audit restarts, backups and schedule executions with timestamps.</li>
          <li>Export raw console output when debugging—the download icon saves a text file for offline analysis.</li>
        </ul>
      </section>

      <section className="space-y-6">
        <h2 className="text-2xl font-semibold">Send metrics to your observability stack</h2>
      ...
      <section className="space-y-6">
        ...
        <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
          ...
          <li>Rotate files nightly with logrotate or a scheduled archive task to avoid disk exhaustion.</li>
          <li>Tag logs with the server ID and environment to filter quickly during investigations.</li>
        </ul>
      </section>
      ...
      <section className="space-y-6">
        ...
        <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
          <li>Link alerts to specific troubleshooting sections—start with the{" "}
            ...
            .</li>
          <li>Run quarterly game days where you intentionally break staging servers and follow your response checklist.</li>
          <li>Track mean time to acknowledge (MTTA) and mean time to resolve (MTTR) so improvements are measurable.</li>
        </ul>
      </section>
