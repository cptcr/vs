    ...
    <div className="max-w-3xl space-y-10">
      <header className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          Reverse proxies terminate TLS and forward traffic to the internal port
          your workload listens on. Pair them with custom domains to provide
          HTTPS endpoints for players and automation.
        </p>
      </header>
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          From your server sidebar, choose <em>More</em> → <em>Proxy</em>. This
          view lists existing proxies and their SSL status.
        </p>
        <DocsScreenshot
          image={openProxyMenu}
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Click <em>Create Proxy</em> to open the configuration modal. Have your
          domain ready and make sure it resolves to the server IPv4 via an A
          record.
        </p>
        <DocsScreenshot
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          Point your A record directly at the server IP. Disable third-party
          proxy toggles (like Cloudflare&apos;s orange cloud) while the
        ...
        <ul className="pl-6 space-y-2 list-disc text-muted-foreground">
          <li>
            Toggle <em>Let&apos;s Encrypt</em> for automatic certificate
            issuance and renewals.
          </li>
          <li>
            Uploading your own certificate? Provide the full chain and private
            key in PEM format.
          </li>
          <li>
            Re-enable upstream CDNs after SSL verification succeeds if you need
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground">
          After creation, the proxy appears in the list with real-time status
          indicators. Test HTTPS from a browser or curl to confirm the
          certificate and allocation forwarding work as expected.
        </p>
        <DocsScreenshot
