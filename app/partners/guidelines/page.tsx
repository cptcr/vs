...
const channelRequirements = [
  {
    ...
    description: "Keep your server healthy, purposeful, and aligned with our infrastructure-focused audience.",
    requirements: [
  ...
  },
  {
    ...
    description: "Show consistent reach and on-brand storytelling across your short-form channels.",
    requirements: [
  ...
  },
  {
    ...
    description: "Highlight your audience and engagement across long-form video content.",
    requirements: ["Average 200 views per video across recent uploads or series."],
  },
]
...
export const metadata = buildMetadata({
  ...
  description: "Review VaultScope partner eligibility requirements and the steps to submit your partnership application.",
      ...
      <div className="mx-auto max-w-3xl space-y-12">
        <header className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground">
            Here&apos;s what we look for when evaluating new partners across Discord, social platforms, and YouTube.
            Review the requirements, then open a ticket so our team can learn more about your community.
          </p>
          <p className="text-sm text-muted-foreground">
            Official Discord server:{" "}
            <a href={discordInviteUrl} target="_blank" rel="noopener noreferrer" className="font-medium text-primary">
        ...
        <section className="space-y-6">
          {channelRequirements.map((channel) => (
            <Card key={channel.title} className="border border-border/60 bg-background/60 backdrop-blur">
              <CardHeader>
        ...
        <Card className="border border-border/60 bg-background/60 backdrop-blur">
          <CardHeader>
            ...
            <CardDescription>Set expectations around visibility and deliverables for both sides.</CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-sm text-muted-foreground">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Open a ticket and our partnerships team will follow up with next steps.</CardDescription>
          </CardHeader>
