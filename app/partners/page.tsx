...
export const metadata = buildMetadata({
  title: 'Partners',
  description:
    'Explore VaultScope partnership opportunities and learn how to collaborate with our team.',
  path: '/partners',
});
      ...
      <div className="mx-auto max-w-5xl space-y-12">
        <header className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground">
            Learn about current collaborations, explore eligibility
            requirements, and see how to launch a joint program with VaultScope.
            Review our{' '}
            <Link
              href="/partners/guidelines"
          ...
          <section className="space-y-6">
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground">
                Accepted partners are showcased here without separate
                announcements or complimentary server credits by default.
              </p>
            </div>
