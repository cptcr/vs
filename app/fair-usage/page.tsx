...
export const metadata = buildMetadata({
  ...
  description:
    "Guidelines that explain how shared resources may be used across VaultScope's free and paid services.",
  path: '/fair-usage',
});
      ...
      <main className="container max-w-4xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-foreground">
          <section className="space-y-4 leading-relaxed text-muted-foreground">
            <p>
              VaultScope provides a generous free tier and shared resource pools
              to help builders experiment without a credit card. This Fair Usage
              Policy explains how we balance that flexibility with the
              responsibility to keep the platform stable for everyone. It
              applies to every workload, whether it runs on the free tier, paid
              Minecraft servers, or bespoke infrastructure.
            </p>
            <p>
          ...
          <section className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Use resources within the limits of your plan. Sustained
                consumption that degrades neighbouring workloads may be
          ...
          <section className="space-y-4 leading-relaxed text-muted-foreground">
            <div>
              ...
              <p className="mt-2">
                We allow short bursts for deployments, backups, or major content
                drops. Please open a ticket in advance if you expect a burst
                that will exceed your plan for more than 30 minutes so we can
                allocate capacity proactively.
              </p>
            </div>
            <ul className="pl-6 space-y-2 text-sm list-disc">
              <li>
                Paid tiers may request a scheduled burst with at least 24 hours’
                notice.
              </li>
              <li>
                Free tier workloads cannot exceed 2 simultaneous containers per
                account.
              </li>
              <li>
                Minecraft servers may not run more than one intensive world
                reset per hour without prior approval.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4 leading-relaxed text-muted-foreground">
            <div>
              ...
              <p className="mt-2">
                Our goal is to nudge rather than surprise. Most issues are
                resolved with a quick conversation, but we reserve the right to
                act immediately when the platform is at risk.
              </p>
            </div>
          ...
          <section className="space-y-4 leading-relaxed text-muted-foreground">
            <div>
              ...
              <p className="mt-2">
                If your workload requires sustained usage beyond these limits,
                reach out so we can scope a dedicated or higher tier
                environment.
              </p>
            </div>
            <ul className="pl-6 space-y-2 text-sm list-disc">
              ...
              <li>
                Provide at least 3 business days for us to review bespoke or
                burst requests.
              </li>
              <li>
                We may offer alternative architectures (queue workers, dedicated
                nodes, etc.) where appropriate.
              </li>
            </ul>
          </section>
