        ...
        <div className="space-y-8 text-foreground">
          ...
          <section>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                VaultScope is the data controller within the meaning of Art.
                4(7) GDPR.
              </p>
            ...
            <div className="space-y-4 text-muted-foreground">
              <ul className="pl-6 space-y-2 list-disc">
                <li>
                  ...
                  Email address, username, encrypted password
                </li>
                <li>
                  <strong className="text-foreground">
                    Service Usage Data:
                  </strong>{' '}
                  Server configurations, resource usage, and panel activity via
                  Pterodactyl
                </li>
                <li>
                  <strong className="text-foreground">
                  ...
                  Payment preferences and transaction references processed via
                  Stripe (no full card data stored)
                </li>
                <li>
                  <strong className="text-foreground">Technical Data:</strong>{' '}
                  IP addresses, browser type, device information, and access
                  logs
                </li>
                <li>
                  <strong className="text-foreground">Communications:</strong>{' '}
                  Support tickets, emails, and Discord messages
                </li>
                <li>
                  <strong className="text-foreground">Analytics:</strong> Usage
                  data collected through Google Analytics (consent-based)
                </li>
              </ul>

              <p className="text-sm">
                VaultScope accepts payments exclusively via Stripe. Full payment
                credentials remain with Stripe in accordance with{' '}
                <a
          ...
          <section>
            ...
            <ul className="pl-6 space-y-2 list-disc text-muted-foreground">
              ...
              <li>
                Processing payments and managing billing through Stripe and
                Paymenter
              </li>
          ...
          <section>
            ...
            <ul className="pl-6 space-y-2 list-disc text-muted-foreground">
              <li>
                <strong className="text-foreground">Account Data:</strong> 7
                days after termination
              </li>
              <li>
                <strong className="text-foreground">Billing Data:</strong> 1
                year after termination
              </li>
              <li>
                <strong className="text-foreground">Logs:</strong> 7 days after
                termination
              </li>
              <li>
                <strong className="text-foreground">Analytics:</strong> Governed
          ...
          <section>
            ...
            <ul className="pl-6 space-y-2 list-disc text-muted-foreground">
              ...
              <li>
                <strong className="text-foreground">Trustpilot:</strong> Review
                invitations based on legitimate interest –{' '}
                <a
              ...
              <li>
                <strong className="text-foreground">Pterodactyl:</strong> Server
                & panel management
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Where data is processed outside the EU/EEA, we rely on appropriate
              safeguards such as EU Standard Contractual Clauses or adequacy
              decisions.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                We require explicit consent before setting non-essential
                cookies. You can manage or withdraw consent at any time via our
                cookie settings.
              </p>
              <p>
                Stripe may set cookies for fraud prevention and security
                purposes.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              VaultScope does not use automated decision-making or profiling
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Under EU consumer law, the right of withdrawal expires immediately
              for digital services once service delivery begins with your
              consent. Refunds are generally not offered.
            </p>
          </section>
